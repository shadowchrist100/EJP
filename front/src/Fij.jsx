                ...
                return (
                    <div key={index} className="w-full h-80 perspective-1000">
                        <div className={`thecard relative w-full h-full transition-transform duration-700 ${isFlipped ? 'rotate-y-180' : ''}`}>
                            {/* face avant */}
                            <div className="thefront absolute w-full h-full rounded-xl flex flex-col backface-hidden shadow-xl border-2 border-gray-200 overflow-hidden bg-white">
                                <div
                                ...
                                <div className="p-5 flex-grow flex flex-col justify-between bg-gradient-to-b from-white to-gray-50">
                                    ...
                                    <div className="flex gap-3  ">
                                        <button
                                            ...
                                            className=" bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-5 py-3 rounded-lg transition-all duration-300 font-semibold shadow-md hover:shadow-lg hover:scale-105 flex items-center justify-center gap-2"
                                        >
                                            Voir la carte
                                        ...
                                        <a
                                            ...
                                            className=" w-40 bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white  rounded-lg transition-all duration-300 font-semibold shadow-md hover:shadow-lg hover:scale-105 flex items-center justify-center"
                                        >
                            ...
                            {/* face arriere */}
                            <div className="theback absolute w-full h-full bg-white rounded-xl overflow-hidden flex flex-col backface-hidden rotate-y-180 shadow-xl border-2 border-blue-200">
                                <iframe
                                    src={fij.mapURL}
                                    width="100%"
                                    height="100%"
                                ...
                                <button
                                    onClick={() => toggleFlip(index)}
                                    className="bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-800 hover:to-gray-900 text-white px-5 py-4 transition-all duration-300 font-semibold hover:shadow-lg flex items-center justify-center gap-2"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
