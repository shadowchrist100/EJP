            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="max-w-4xl mx-auto text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <h1 className="text-5xl sm:text-7xl md:text-8xl font-black text-white mb-8 tracking-tighter leading-none">
                        Sois <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-yellow-400 to-amber-600">Partenaire</span> de la Vision S.T.A.R.
                    </h1>
                    ...
                    <div className="grid grid-cols-3 gap-6 mb-12 max-w-2xl mx-auto">
                        <div className="p-4 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm hover:border-amber-500/50 transition-all duration-300">
                            <p className="text-3xl font-black text-amber-400 mb-2">500+</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    {donationPlans.map((plan, idx) => (
                        ...
                        >
                            ...
                            {/* Glow Effect */}
                            <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity rounded-3xl blur-2xl ${
                                plan.popular ? 'bg-amber-500/20' : 'bg-amber-500/10'
                            }`} />
                            ...
                            <div className="relative p-8 flex flex-col h-full">
                                ...
                                {/* CTA Button */}
                                <button className={`w-full py-3 rounded-xl font-black uppercase text-[10px] tracking-widest transition-all duration-300 flex items-center justify-center gap-2 group/btn overflow-hidden relative ${
                                    selectedOption === plan.id || plan.popular
