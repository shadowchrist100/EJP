...
const MinistriesSection = () => {
    ...
    const ministries = [
        ...
        { category: 'Musique', title: 'Prodige Music', description: "Lève-toi et chante ! Exprime ton amour à travers la musique et conduis les autres à la louange sincère. Aucune expérience requise, juste une passion.", image: 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=600&fit=crop' },
