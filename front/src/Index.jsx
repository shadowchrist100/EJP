            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10 ">
                <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center ">
                    ...
                    <div>
                        ...
                        {/* Citation */}
                        <div className="border-l-2 border-amber-500/40 pl-6 mb-8">
                        ...
                        <div className="space-y-4 mb-10">
                            ...
                            <p className="text-gray-500 text-[15px] font-light leading-relaxed">
                                Visionnaire, orateur et homme de foi, il porte depuis plus de deux
                        ...
                        {/** CTA */}
                        <a href="">En savoir plus <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" /> </a>
                    </div>
                    ...
                    <div className="relative hidden md:block" style={{ height: '600px' }} >
                        ...
                        {/* Photo - remplacer src par votre image */}
